...
The outcome of this study is basically that we might be able to make RLHF-based training more efficient and accessible -- but it remains to be seen how these RLAIF models perform in qualitative studies that focus on safety and truthfulness of the information content, which is only partially captured by human preference studies.
