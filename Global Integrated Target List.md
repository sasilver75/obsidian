...
aliases:
  - GITL
---
See also: [[Joint Integrated Prioritized Target List]] (JIPTL)

Because airpower can deliver effects across vast distances, a target's geographic location is often less important than the adversary system to which it belongs.

The GITL is adversary-focused, rather than a geographically-oriented list of targets.
