...
5. Attack Systems: Designated assets assigned to do the job, which can range from lethal artillery to non-lethal [[Electronic Warfare]]

The matrix is typically developed during the decide, detect, deliver, assess methodology process to synchronize intelligence assets with firing platforms.
