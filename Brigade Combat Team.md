...
- ==Infantry Brigade Combat Team (IBCT)==
	- 4,413 soldiers, 3 [[Battalion]]s of infantry, along with a cavalry/reconnaissance battalion, a [[Brigade Support Battalion]], an engineer battalion, and a field artillery (fires) battalion, totaling seven battalions.
	- As of May 2025, all IBCTs will convert to MBCTs.
- ==Stryker Brigade Combat Team==
	- Designed around Strykers, meant to be deployable by C-130s within 96 hours.
- ==Armored Brigade Combat Team==
	- Designed around M1 Abrams and M2 Bradleys, along with HMMWVs and M113 APCs.
...
There's also use of the term ==Light Brigade Combat Team (LBCT)==, which is what some IBCTs have have experimentally transformed into.
- Designed to be a lethal and adaptable formation for fighting in heavily restricted terrain ([Link](https://www.army.mil/article/284079/reconnaissance_in_the_light_brigade_combat_team)).
...
![[Pasted image 20260526204409.png]]
