...
A ==dataset of 52,000 instructions== generated with OpenAI APIs that kicked off a big wave of people using OpenAI to generate synthetic data for instruction-tuning, costing about $500 to generate.
