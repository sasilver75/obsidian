...
Grafana connects to Prometheus as a data source -- other possible data sources include [[Grafana Loki|Loki]], [[ElasticSearch]], [[PostgreSQL]], [[Amazon CloudWatch|CloudWatch]], [[InfluxDB]], Tempo, and many more.
