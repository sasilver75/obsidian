While Apache Sedona is a cluster computing system for processing large-scale spatial data, SedonaDB is an open-source, single-node analytical database engine with geospatial as as first-class citizen.

I think we can think of it like [[DuckDB]] (columnar single node), but with geospatial in mind rather than as an extension.
