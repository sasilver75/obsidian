...
---
References:
- Wikipedia: [Brigade Support Batallion](https://en.wikipedia.org/wiki/Brigade_support_battalion)
...
- Consists of:
	...
	- ==Field Maintenance Company==
		- Performs field-level maintenance support on or near unserviceable equipment or weapon systems for its parent brigade and BSB.
	- ==Distribution Company==
		- Manages the daily receipt, storage, and issuance of [[Class of Supply|Supply Class]] I, II, III, IV, V, and IX in support of the parent brigade.
		- Supplies are received from the [[Division Sustainment Support Battalion]], and are distributed one of two ways:
...
While [[Forward Support Company|Forward Support Companies]] (FSCs) operate in close proximity with their supported battalion, the rest of the [[Brigade Support Battalion]] (BSB) operates from a base or base cluster in a designated ==brigade support area== (BSA).

From this Brigade Support Area, the BSB commander executes [[Command and Control]] of BSB units based on orders from the brigade commander. 

The BSB commander also coordinates with the [[Division Sustainment Support Battalion]] (DSSB) for capabilities it lacks, such as light infantry troop transportation or water treatment.

__________


The BSB commander is the brigade's senior logistician.
![[Pasted image 20260517221406.png]]
