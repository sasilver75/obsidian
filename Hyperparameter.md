...
Examples are [[Learning Rate]], number of epochs, [[Batch (Machine Learning)]] size, Kernel Size, Stride, various Pooling settings, or even (?) sampling strategies in LMs.