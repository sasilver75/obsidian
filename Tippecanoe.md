...
Tippecanoe is the spiritual predecessor and open-source equivalent of MTS; maintenance has since been handed off Tippecanoe maintenance to felt.com, a mapping startup, so it's no longer a Mapbox project.
