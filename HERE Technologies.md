...
==Primarily used by automotive and enterprise logistics companies.==

HERE sells:
- Road network data with turn restrictions, speed limits, lane geometry -- very high prevcision, used for navigation and ADAS (Advanced Driver Assistance Systems)
- POI data
- REal-time traffic
- HD maps for autonomous driving (centimeter-level road geometry)
