...
A mobile interceptor surface-to-air missile system from [[Raytheon]]; the primary such system used by the [[United States Army|Army]]'s [[Air Defense Artillery]] (and widely exported).

The [[ANMPQ-53|AN/MPQ-53]] radar at the heart of the system is the "Phased Array Tracking Radar to Intercept on Target," which is a backronym for "Patriot."
- The [[ANMPQ-65]] was developed and used alongside the [[MIM-104 Patriot|PAC-3 MSE]] upgrade.

Patriot Systems are designed around [[Battalion]]s; a Patriot battalion consists of a HQ battery, a maintenance company, and 4-6 "line batteries" which are the actual launching batteries that employ the Patriot systems. Each line battery consists of six launchers and 3-4 platoons (fire control platoon, launcher platoon, headquarters/maintenance platoon).
...
- ==MIM-104B (PAC-1)==: 1988 upgrade providing limited capability against [[Short-Range Ballistic Missile|SRBM]]s. PAC = "Patriot Advanced Capability"
- ==MIM-104C/D (PAC-2 GEM-T)==: 1990, tests began to indicate that the Patriot was capable of intercepting ballistic missiles, but the MIM-104A/B missile might not be able to destroy them reliable. Radar search algorithms were optimized, and a major missile upgrade, with the introduction of the MIM-104C, or PAC-2 missile. Just prior to OIF, it was decided to further upgrade the GEM and PAC-2 missiles, producing the GEM-T and GEM-C missiles. 
