...
- We present [[ReAct (Agent)]], a general paradigm to combine reasoning and acting with language models for solving diverse language reasoning and decision making task.
...
- The authors notice that the problem solving process generated by [[ReAct (Agent)]] is more factual and grounded, whereas [[Chain of Thought|CoT]] is more accurate in formulating reasoning structure, but can suffer from hallucination.
