...
- Provides a [[Pandas]]-like Python API that compiles down to SQL and runs against a backend database or query engine (e.g. [[DuckDB]], [[Google BigQuery]], [[Snowflake]], [[PostgreSQL|Postgres]], etc.)
