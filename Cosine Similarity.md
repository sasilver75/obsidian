Cosine similarity is a measure of similarity between two vectors, defied in terms of the *cosine of the angle between them.* It's used often to measure document similarity in text analysis.
