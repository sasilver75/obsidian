...
A Python library for reading and writing [[Raster]] geospatial data, things like:
- Satellite imagery
- Aerial photos
- Elevation models
...
The underlying engine is called "[[GDAL]]" (Geospatial Data Abstraction Library), which has existed since the late 90s and supports ~160 raster formats.
