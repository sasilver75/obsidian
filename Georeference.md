...
The process typically involves identifying a sample of several ==ground control points (GCPs)== with known locations on the image and the ground, then using curve fitting techniques to generate a parametric formula to transform the rest of the image.
