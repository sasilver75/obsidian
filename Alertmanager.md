A [[Prometheus]] ecosystem component that receives firing alerts, groups them, deduplicates them, suppresses less-useful ones, and routes notifications to humans or incident systems like PagerDuty, Slack, email, or webhooks.
