...
- Parts that Fly
	...
	- The Flight System: Everything required to give the drone to ability to fly and stay aloft
		...
		- ==Motors==: High-performance motors used for FPVs are typically [[Brushless Motors]], which can spin at speeds exceeding tens of thousands of revolutions per minute.
