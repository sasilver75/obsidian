...
- ==One LAZ File = one COPC file==; it reorganizes the points from the point cloud dataset into a spatially-indexed file use spatial [[Octree]], ==allowing for partial reads==.
