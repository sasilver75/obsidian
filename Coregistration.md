...
- Critical for [[InSAR]], which measures surface deformity by comparing the phase difference of two SAR acquisitions. Phase is extremely sensitive, a shift of half-a-wavelength (~3cm for [[C-Band]]) completely changes the measurement. Sub-pixel misalignment introduces phase errors that swamp the deformation signal you're trying to measure.
